...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['username'], $_POST['role']) && !isset($_SESSION['username_input'])) {
        ...
        if (isset($_SESSION['clientID']) && (($clientKey === $_SESSION['clientID']) || ($clientKey === $kingID))) {
        ...
        $message = "All inputs and session key have been reset.";
    }
}
?>
<!DOCTYPE html>
...
<body class="bg-gray-100">
    <div class="container mx-auto px-8 py-12">
        <h1 class="text-5xl font-bold text-center text-blue-800 mb-12">Welcome to the Crabby Bank</h1>
        ...
        <?php if (isset($message)): ?>
            <p class="text-center text-green-600 font-bold mt-6 text-lg"><?php echo htmlspecialchars($message, ENT_QUOTES, 'UTF-8'); ?></p>
        <?php endif; ?>
